...
with country_sources (
  ...
  values
    ...
    ('hu', 'Hungary', 'Hungarian National Authority for Data Protection and Freedom of Information', 'https://www.naih.hu/', 'Hungarian National Legislation Database', 'https://njt.jog.gov.hu/', '(("artificial intelligence" OR "AI Act" OR "mesterseges intelligencia") AND Hungary AND (law OR regulation OR legal OR NAIH))', '("artificial intelligence" OR "AI Act" OR "mesterseges intelligencia") AND Hungary AND (law OR regulation OR NAIH)', 'portfolio.hu,jogaszvilag.hu,hvg.hu,reuters.com,politico.eu,euractiv.com'),
