...
| T-PILOT-COUNTRY-DEEP-ENTRIES | Codex | DONE-LOCAL | `main` @ working tree | `scripts/backfill-pilot-country-deep-entries.ts`, `package.json` | `updateRepository.createRawItem()`, `updateRepository.createUpdate()`, `SourceReference`, community "DB Repository Layer", community "Scan Pipeline" | 2026-07-15 |
