...
- **2026-07-18 labor/social-law note**: `legalAreas` now includes `Labor and social law` for AI issues involving employment, workplace AI, hiring, workers, platform work, algorithmic management, collective bargaining, and social-law enforcement. Keep `Employment` backward-compatible, but route new employment/workplace/labour signals to `Labor and social law`.
- **2026-07-18 labor/social-law baseline note**: `scripts/backfill-labor-social-law-baseline.ts` publishes official/institutional labor/social-law AI anchors, including EU Platform Work Directive, AI Act high-risk employment systems, GDPR Article 22, EP/JRC/EPRS/Eurofound workplace-AI materials, and EEOC ADA/AI guidance. It is idempotent by raw-item hash.
- **2026-07-18 EU country-domain baseline note**: `legalAreas` now includes `Cloud and infrastructure`; `scripts/backfill-eu-country-domain-baseline.ts` publishes 162 official EU-law country layers across all 27 EU Member States and 6 domains: AI governance, data protection, cloud/infrastructure, copyright/generative AI, labor/social law, and automated-decision case-law. These entries are verified official EU layers for country pages; they are not proof that national implementation, national case law, or authority designation is complete. Country agents must deepen them with national official sources and reliable legal news.
- **2026-07-18 Austria country-by-country depth note**: `src/content/ai-regulation/austria-national-depth.ts` is the first strict national-depth corpus in the new country-by-country pass; `scripts/backfill-austria-national-depth.ts` publishes 7 official-source Austrian entries across AI governance, data protection, cloud/infrastructure, copyright/generative AI, labor/social law, and automated-decision case-law. Keep this pattern for the next countries: one national module, one test, one idempotent backfill script, verified official sources first.
- **2026-07-19 Belgium country-by-country depth note**: `src/content/ai-regulation/belgium-national-depth.ts` continues the national-depth pass; `scripts/backfill-belgium-national-depth.ts` publishes 7 official-source Belgian entries covering BOSA's national AI convergence plan, the federal Data and AI Ethics Advisory Committee, Belgian DPA AI/GDPR and automated-decision guidance, Belgian TDM copyright law, data/infrastructure policy, and Labour Deal platform-work algorithmic control. Continue with Bulgaria, Croatia, Cyprus, Czechia, then Denmark using the same pattern.
- **2026-07-19 Bulgaria country-by-country depth note**: `src/content/ai-regulation/bulgaria-national-depth.ts` continues the national-depth pass; `scripts/backfill-bulgaria-national-depth.ts` publishes 7 official-source Bulgarian entries covering AI Concept 2030, open-government AI standards, CPDP/KZLD GDPR and Article 22 guidance, DSM/TDM copyright implementation, AI data/cloud/HPC infrastructure policy, and Labour Code algorithmic-management rules for remote work. Continue with Croatia, Cyprus, Czechia, then Denmark using the same pattern.
- **2026-07-19 Croatia country-by-country depth note**: `src/content/ai-regulation/croatia-national-depth.ts` continues the national-depth pass; `scripts/backfill-croatia-national-depth.ts` publishes 7 official-source Croatian entries covering the National AI Development Plan process, Digital Decade AI/cloud infrastructure policy, AZOP GDPR transparency and Article 22 AI guidance, DSM/TDM copyright implementation, Labour Act ICT remote-work rules, and SmartWorking public-sector monitoring. Continue with Cyprus, Czechia, then Denmark using the same pattern.
- **2026-07-19 Cyprus country-by-country depth note**: `src/content/ai-regulation/cyprus-national-depth.ts` continues the national-depth pass; `scripts/backfill-cyprus-national-depth.ts` publishes 7 official-source Cypriot entries covering the National AI Strategy, Digital Decade AI/cloud infrastructure policy, DPA DPIA and Article 22 complaint materials, DSM-era copyright/TDM analysis, and the 2023 Teleworking Law including right-to-disconnect safeguards. Continue with Czechia, then Denmark using the same pattern.
- **2026-07-19 Czechia/Denmark/Estonia parallel depth note**: `src/content/ai-regulation/czechia-national-depth.ts`, `denmark-national-depth.ts`, and `estonia-national-depth.ts` were prepared through parallel subagents and published via idempotent backfills. Each country has 7 official-source national-depth entries covering all 6 country-domain axes. Continue with Finland, Greece, Hungary, Ireland/Italy refreshes, Latvia, Lithuania and Luxembourg using the same isolated country module/test/backfill pattern.
...
**New York AI Law Watch (2026-07-19):** `new-york-ai-law-depth` published 48 verified New York AI-law entries to Supabase and registered/confirmed 10 active live sources: NY Law Reporting Bureau AI decisions, NY Courts Part 161/rules, CourtListener NY federal AI privilege/work-product query, DCWP AEDT, NYC Rules AEDT, NYC OTI AI governance, NY legislature AI bills, RAISE Act, NYDFS, and NY AG. Reports from parallel agents live under `docs/agent-ny-reports/`. Secondary/comparator work-product sources such as Warner/Morgan remain research leads, not verified New York entries.
